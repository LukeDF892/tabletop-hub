...
export default function WarhammerGameRoom() {
  ...
  function resolveSaveRolls() {
    ...
    addLog(`Saves: ${effectiveFinalSave}+ needed (Sv${saveBase}, AP${ap}${coverApplies ? ", +1 cover" : ""}${saveBonusNote}) → ${rolls.join(", ")} → ${unsaved} unsaved → ${totalDmg} damage${dmgNote}.`, target.player);

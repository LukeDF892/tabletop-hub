...
export const TYRANID_UNITS: Unit[] = [
  ...
  },
  {
    ...
    abilities: [
      { name: "Spore Cloud", description: "Friendly Tyranids INFANTRY and BEAST units within 6\" of this unit have the benefit of Light Cover against ranged attacks (if they don't already have a better save modifier)." },
    ],

...
export const TYRANID_UNITS: Unit[] = [
  ...
  },
  {
    ...
    keywords: ["Monster", "Character", "Synapse", "Psyker", "Hive Tyrant"],
    factionKeywords: ["Tyranids"],
    wargearOptions: [
      { description: "May replace Monstrous Scything Talons with Heavy Venom Cannon or Bio-Plasma." },
    ],
    weaponOptions: [
      {
  ...
  },
  {
    ...
    keywords: ["Infantry", "Character", "Fly", "Synapse", "Tyranid Warriors", "Tyranid Prime"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-tervigon",
    ...
    weapons: [
      ...
      { name: "Massive Scything Talons (Strike)", type: "Melee", attacks: "6", skill: "WS3+", strength: "8", ap: "-2", damage: "2" },
      { name: "Massive Scything Talons (Sweep)", type: "Melee", attacks: "12", skill: "WS3+", strength: "6", ap: "-1", damage: "1" },
    ],
    abilities: [
      { name: "Spawn Termagants", description: "At the start of your Movement phase, this model can spawn D6 Termagant models and add them to a friendly Termagant Brood unit within 6\" (max 30 models in that unit)." },
      { name: "Synaptic Link", description: "Friendly Termagant units within 6\" of this model do not need to take Battleshock tests." },
    ],
    keywords: ["Monster", "Character", "Synapse", "Psyker", "Great Devourer", "Tervigon"],
    factionKeywords: ["Tyranids"],
    canLeadUnits: ["tyr-termagants"],
  },
  {
    id: "tyr-old-one-eye",
    name: "Old One Eye",
    ...
    abilities: [
      ...
      { name: "Eternal Warrior", description: "Reduce the damage of any attack against this model by 1 (minimum 1)." },
    ],
  ...
  },
  {
    ...
    abilities: [
      { name: "Implant Attack", description: "When this model makes an Implant Attack (Barbed Ovipositor) and scores a wound, instead of dealing damage the target takes 1 wound with no saves allowed, and if killed, D3 Ripper Swarm bases are placed within 6\" of it." },
      { name: "Fly", description: "This model can move over models and terrain." },
    ],
    keywords: ["Infantry", "Character", "Epic Hero", "Fly", "Synapse", "Parasite of Mortrex"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-deathleaper",
    ...
    abilities: [
      { name: "It's After Me!", description: "When this model is deployed, pick one enemy CHARACTER — until this model is destroyed, that character must subtract 2 from all Battleshock tests." },
      { name: "A Shadow in the Warp", description: "This model cannot be targeted by Stratagems." },
      { name: "Infiltrators", description: "This model can be set up anywhere more than 9\" from the enemy deployment zone and enemy models." },
    ],
    keywords: ["Infantry", "Character", "Epic Hero", "Lone Operative", "Infiltrators", "Deep Strike", "Deathleaper"],
    factionKeywords: ["Tyranids"],
  },
  {
    ...
    abilities: [
      { name: "Implacable Advance", description: "This model can Advance and still shoot Heavy weapons without penalty. Its Advance roll is always a minimum of 6\"." },
      { name: "Synaptic Overload", description: "Friendly Tyranid SYNAPSE units within 12\" have the range of their Synapse ability increased by 3\"." },
    ],
    keywords: ["Monster", "Character", "Synapse", "Psyker", "Norn Emissary"],
    factionKeywords: ["Tyranids"],
  },
  {
    ...
    abilities: [
      { name: "Biomass Assimilation", description: "Each time a model is destroyed within 6\" of this model, roll D6; on a 5+ this model regains 1 lost wound." },
      { name: "Synaptic Siphon", description: "Friendly Tyranid CORE units within 12\" may re-roll wound rolls of 1." },
    ],
  ...
  // ─── BATTLELINE ───────────────────────────────────────────────────
  {
    ...
    abilities: [
      { name: "Chitinous Horde", description: "Each model in this unit within 6\" of another model in the same unit counts as 2 models for Objective Control purposes." },
    ],
  ...
  },
  {
    ...
    keywords: ["Infantry", "Core", "Battleline", "Great Devourer", "Barbgaunts"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-neurogaunts",
    name: "Neurogaunt Nodegroup",
    role: "Infantry",
    category: "Battleline",
    ...
    abilities: [
      { name: "Synaptic Link", description: "While this unit is within 6\" of a friendly SYNAPSE unit, add 1 to the OC characteristic of each model in this unit." },
      { name: "Neurological Nodes", description: "At the start of your Command Phase, if this unit contains 15 or more models, it does not need to take Battleshock tests." },
    ],
    keywords: ["Infantry", "Core", "Battleline", "Neurogaunts"],
    factionKeywords: ["Tyranids"],
  },
  {
    ...
    role: "Beast",
    category: "Battleline",
    stats: { movement: '5"', toughness: 2, save: "6+", wounds: 3, leadership: "8+", oc: 1 },
    models: { min: 3, max: 6 },
    points: 45,
    pointsPerModel: 15,
    weapons: [
    ...
    abilities: [
      { name: "Swarm", description: "This unit ignores any effects that target models with a specific base size." },
    ...
    keywords: ["Beast", "Core", "Battleline", "Ripper Swarms"],
    factionKeywords: ["Tyranids"],
  },
  {
    ...
    abilities: [
      { name: "Pouncing Leap", description: "This unit can Advance and still charge in the same turn. When this unit makes a Charge move, add 1\" to the charge distance." },
      { name: "Infiltrators", description: "Before the first battle round, this unit can be set up anywhere more than 9\" from the enemy deployment zone." },
    ],
    keywords: ["Infantry", "Core", "Battleline", "Infiltrators", "Deep Strike", "Von Ryan's Leapers"],
    factionKeywords: ["Tyranids"],
  },
  // ─── ELITES ───────────────────────────────────────────────────────
  {
  ...
  },
  {
    ...
    abilities: [
      { name: "Synaptic Disruption", description: "Enemy SYNAPSE units within 6\" of this model subtract 1 from their Leadership and cannot use their Synapse ability." },
      { name: "Lone Operative", description: "While not within 3\" of any friendly unit, this model cannot be targeted by ranged attacks unless it is the closest eligible target." },
    ],
    keywords: ["Infantry", "Character", "Lone Operative", "Infiltrators", "Deep Strike", "Great Devourer", "Vanguard Invader", "Neurolictor"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-raveners",
  ...
  },
  {
    ...
    abilities: [
      ...
      { name: "Warp Field", description: "This unit has a 5++ invulnerable save." },
      { name: "Psyker", description: "This unit can attempt to manifest 1 psychic power per turn." },
    ],
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Crushing Claws and Rending Claws", type: "Melee", attacks: "2", skill: "WS4+", strength: "8", ap: "-2", damage: "2", keywords: ["Twin-linked"] },
    ],
    abilities: [
      { name: "Bodyguard", description: "While a friendly CHARACTER is within 3\" of this unit, each time that CHARACTER model would lose a wound, roll D6; on a 4+ this unit suffers that wound instead." },
    ],
    keywords: ["Infantry", "Core", "Great Devourer", "Tyrant Guard"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-pyrovores",
    ...
    role: "Monster",
    category: "Elites",
    stats: { movement: '7"', toughness: 6, save: "4+", wounds: 4, leadership: "8+", oc: 1 },
    models: { min: 1, max: 3 },
    points: 30,
    pointsPerModel: 30,
    weapons: [
    ...
    abilities: [
      { name: "Volatile Bio-Acids", description: "When this model is destroyed, before removing it from the battlefield, roll D6; on a 4+ every unit within 3\" takes D3 mortal wounds." },
    ],
    keywords: ["Monster", "Core", "Pyrovore"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-venomthropes",
    ...
    abilities: [
      { name: "Spore Cloud", description: "Friendly Tyranids INFANTRY and BEAST units within 6\" of this unit have the benefit of Light Cover against ranged attacks." },
    ],
  ...
  },
  {
    ...
    abilities: [
      { name: "Psychic Abomination", description: "Enemy PSYKER models within 12\" cannot manifest more than one psychic power per phase." },
      { name: "Ocular Assault", description: "Ranged attacks from this model ignore Look Out, Sir! and Lone Operative." },
    ],
    keywords: ["Monster", "Core", "Synapse", "Psyker", "Maleceptor"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-psychophage",
    ...
    abilities: [
      { name: "Soulfire", description: "When this model destroys an enemy PSYKER model, add D3 to this model's Attacks characteristic until end of turn." },
      { name: "Psychic Hunger", description: "Each time this model destroys a PSYKER model, it regains D3 lost wounds." },
    ],
    keywords: ["Monster", "Core", "Great Devourer", "Harvester", "Psychophage"],
    factionKeywords: ["Tyranids"],
  },
  {
  ...
  },
  {
    ...
    abilities: [
      { name: "Fly", description: "This unit can move over models and terrain." },
      { name: "Living Bomb", description: "When a model in this unit is destroyed, before removing it, all units within 6\" suffer D3 mortal wounds." },
      { name: "Mindless", description: "This unit automatically passes Battleshock tests." },
    ],
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Scything Wings", type: "Melee", attacks: "4", skill: "WS4+", strength: "7", ap: "-1", damage: "2" },
    ],
    abilities: [
      { name: "Fly", description: "This model can move over models and terrain." },
      { name: "Swooping Assault", description: "When this model makes a charge move, it may move over all terrain and enemy models." },
    ],
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Stinger Salvoes", type: "Ranged", range: '24"', attacks: "8", skill: "BS3+", strength: "5", ap: "0", damage: "1" },
      { name: "Scything Wings", type: "Melee", attacks: "4", skill: "WS4+", strength: "7", ap: "-1", damage: "2" },
      { name: "Thorax Spur", type: "Melee", attacks: "1", skill: "WS3+", strength: "10", ap: "-3", damage: "D6", keywords: ["Anti-Fly 3+", "Extra Attacks"] },
    ],
    abilities: [
      { name: "Fly", description: "This model can move over models and terrain." },
      { name: "Swooping Assault", description: "When this model makes a charge move, it may move over all terrain and enemy models." },
  ...
  },
  {
    ...
    weapons: [
      ...
      { name: "Claws and Teeth", type: "Melee", attacks: "2", skill: "WS4+", strength: "7", ap: "0", damage: "1" },
    ],
    abilities: [
      { name: "Instinctive Guidance", description: "This unit does not need line of sight to targets when using the Impaler Cannon." },
    ],
    keywords: ["Infantry", "Core", "Great Devourer", "Hive Guard"],
    factionKeywords: ["Tyranids"],
    wargearOptions: [
      { description: "Any number of models may replace their Impaler Cannon with a Shockcannon." },
    ],
  },
  {
    id: "tyr-mawloc",
    ...
    abilities: [
      { name: "Terror from the Deep", description: "When this unit arrives from Deep Strike, each enemy unit within 9\" suffers D3+3 mortal wounds." },
      { name: "Burrowing", description: "At the end of your Movement phase, this unit can burrow into the ground — remove it from the battlefield and place it in Strategic Reserves." },
    ],
    keywords: ["Monster", "Core", "Great Devourer", "Deep Strike", "Mawloc"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-trygon",
    ...
    abilities: [
      { name: "Subterranean Assault", description: "When this unit arrives from Deep Strike, friendly INFANTRY or BEAST units within 6\" may also immediately arrive from Strategic Reserves, placed within 6\" of this model." },
    ],
    keywords: ["Monster", "Core", "Great Devourer", "Deep Strike", "Trygon"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-biovores",
    ...
    role: "Infantry",
    category: "Heavy Support",
    stats: { movement: '5"', toughness: 4, save: "5+", wounds: 2, leadership: "8+", oc: 1 },
    models: { min: 1, max: 3 },
    points: 45,
    pointsPerModel: 45,
    weapons: [
    ...
    abilities: [
      { name: "Living Artillery", description: "When this model's Spore Mine Launcher misses its target, place one Spore Mine model within 3\" of the target — it remains as a hazard that explodes when enemy units move within 3\" of it." },
    ],
    keywords: ["Infantry", "Core", "Biovore"],
    factionKeywords: ["Tyranids"],
  },
  {
    id: "tyr-toxicrene",
    ...
    abilities: [
      { name: "Noxious Miasma", description: "Enemy units within 3\" subtract 1 from their hit rolls and cannot benefit from cover." },
      { name: "Acid Blood", description: "Each time a model in an enemy unit attacks this model in engagement range and scores a wound, roll D6; on a 5+ that unit takes 1 mortal wound." },
    ],
    keywords: ["Monster", "Core", "Toxicrene"],
    factionKeywords: ["Tyranids"],
  },
  // ─── DEDICATED TRANSPORT ─────────────────────────────────────────
  {
    ...
    abilities: [
      { name: "Spore Pod", description: "This unit can arrive from Strategic Reserves as a Deep Strike deployment. Any units it is transporting are also deployed at the same time." },
      { name: "Living Vessel", description: "This model can transport 1 MONSTER unit with 12 or fewer wounds, or up to 20 INFANTRY models." },
    ],
    keywords: ["Monster", "Fly", "Transport", "Great Devourer", "Vanguard Invader", "Tyrannocyte"],
    factionKeywords: ["Tyranids"],
  },
  // ─── FORTIFICATION ───────────────────────────────────────────────
  {
    ...
    abilities: [
      { name: "Immovable", description: "This model cannot move for any reason." },
      { name: "Spore Dispersal", description: "At the start of your Shooting phase, this model can deploy D3 Spore Mine models within 6\" instead of shooting." },
      { name: "Fortification", description: "Enemy models cannot move through this model's base." },
    ],

...
export interface UnitMarker {
  ...
  modelCount?: number;             // current number of models remaining
  woundsPerModel?: number;         // wounds per individual model (= W stat)
  startingModelCount?: number;     // original model count (for half-strength check)
